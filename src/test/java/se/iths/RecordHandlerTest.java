...
class RecordHandlerTest {
    ...
    void createRecordTest() {
        Record pulledTestRecord = recordHandler.readRecord("Bloop");

        assertNotNull(pulledTestRecord,"The pulled record is null");
        assertEquals("Bloop", pulledTestRecord.getId(), "The pulled record id is incorrect");

        // I'll be honest and say that this is something new for me so im slapping together things from StackOverflow.
        Exception exception = assertThrows(IllegalArgumentException.class, () -> recordHandler.createRecord(
                "Bloop",
                12.3,
                30934,
    ...
    void readRecordTest() {
        ...
        assertNotNull(pulledTestRecord, "The pulled record is null");
        assertEquals("Bloop", pulledTestRecord.getId(), "The pulled record id is incorrect");
        assertEquals(12.3, pulledTestRecord.getDistance(), "The pulled record distance is incorrect");
        assertEquals(30934, pulledTestRecord.getTime(), "The pulled record time is incorrect");
        assertEquals(LocalDate.of(1990, 1, 1), pulledTestRecord.getDate(), "The pulled record date is incorrect");

        //TODO Case-sensitivity is a thing, fix so it matches despite capital/small letters.
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            recordHandler.readRecord("blop");
        });
    ...
    void getRecordIDsTest() {
        ...
        List<String> recordIDs = recordHandler.getRecordIDs();
